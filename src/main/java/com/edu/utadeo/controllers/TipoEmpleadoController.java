...
@RestController
@RequestMapping("/api/tiposEmpleados")
...
public class TipoEmpleadoController {
	...
	@GetMapping("/{id}")
	public TipoEmpleado detail(@PathVariable UUID id) {
	...
	public TipoEmpleado update(@PathVariable UUID id, @RequestBody TipoEmpleado e) {
